...
* 集群配置文件同步
### 23.zk的通知机制
* watch机制，可以理解为注册在znode上的触发器，当数据发生变更时，订阅这个时间的客户端就会得到通知
...
* 锁超时：当与zk断开连接时，zk的临时节点会自动删除，不会发生死锁
### 25.CAP，在zk中的体现
